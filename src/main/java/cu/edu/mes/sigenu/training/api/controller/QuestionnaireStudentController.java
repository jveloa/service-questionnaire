...
public class QuestionnaireStudentController {
    ...
    @ApiOperation(value = "Get a List with all questionnaire student by a student")
    public List<QuestionnaireStudentDto> list(@PathVariable String sigenuId){
        ...
        propertyMapper.addMappings( mapper -> mapper.map(src -> src.getQuestionnarieId().getCareerSigenuId(),
                (destination, value) -> destination.getQuestionnarieId().setCareerSigenuId((String) value)));
